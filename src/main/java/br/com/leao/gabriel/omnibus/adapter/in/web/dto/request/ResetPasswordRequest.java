...
@PasswordMatches
public record ResetPasswordRequest(@NotBlank(message = "Password can't be empty")
                                   @Size(
                                       max = 72,
                                       min = 8,
                                       message = "Password must have a length between 8 and 72 characters")
                                   String password,
                                   @NotBlank(message = "confirm password can't be empty") String confirmPassword) implements
    PasswordConfirmable {
